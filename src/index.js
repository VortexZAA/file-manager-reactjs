...
ReactDOM.render(
  <React.StrictMode>
    <FileManager getList={getList} createDirectory={createDirectory} deletePaths={deletePaths} openFile={openFile} uploadFiles={uploadFiles} rename={rename} features={['createDirectory', 'uploadFiles', 'deletePaths', 'rename']} />
  </React.StrictMode>,
